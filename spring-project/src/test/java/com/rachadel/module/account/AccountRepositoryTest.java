...
public class AccountRepositoryTest {
	...
	public void saveWhenEmailInvalidShouldThrowContraintViolationException() {
		...
		assertTrue(exception.getMessage(). contains("Validation failed for classes [com.rachadel.module.account.domain.Account] during persist time for groups [javax.validation.groups.Default, ]"));
	}
